...
public class MSCircularSlider: UIControl {
    ...
    public var maximumValue: Double = 60.0 {
        didSet {
            setNeedsDisplay()
        }
    }
    ...
    private func frameForMarkingAt(_ index: Int) -> CGRect {
        ...
        percentageAlongCircle = fullCircle ? ((60.0 / CGFloat(markerCount)) * CGFloat(index)) / 60.0 : ((60.0 / CGFloat(markerCount - 1)) * CGFloat(index)) / 60.0
    ...
    private func frameForLabelAt(_ index: Int) -> CGRect {
        ...
        percentageAlongCircle = fullCircle ? ((60.0 / CGFloat(labels.count)) * CGFloat(index)) / 60.0 : ((60.0 / CGFloat(labels.count - 1)) * CGFloat(index)) / 60.0
    ...
    private func offsetForLabelAt(index: Int, withSize labelSize: CGSize) -> CGPoint {
        let percentageAlongCircle = fullCircle ? ((60.0 / CGFloat(labels.count)) * CGFloat(index)) / 60.0 : ((60.0 / CGFloat(labels.count - 1)) * CGFloat(index)) / 60.0
        let labelDegrees = percentageAlongCircle * maximumAngle
